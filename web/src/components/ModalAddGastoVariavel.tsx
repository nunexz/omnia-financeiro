...
interface ModalAddGastoVariavelProps {
  isOpen: boolean
  onClose: () => void
  mesAno: string
}

export default function ModalAddGastoVariavel({ isOpen, onClose, mesAno }: ModalAddGastoVariavelProps) {
  ...
  const mutation = useMutation({
    mutationFn: () =>
      gastosVariaveisAPI.createGasto({
        descricao,
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-dark-800 rounded-lg shadow-lg p-6 w-full max-w-md mx-4 border border-gray-200 dark:border-dark-700">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">Novo Gasto</h2>
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              ...
              className="flex-1 px-4 py-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600 disabled:opacity-50 transition flex items-center justify-center gap-2"
            >
